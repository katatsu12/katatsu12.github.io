<script>
	import { email, github, linkedin } from '$lib/data.js';
</script>
...
<header class="hero">
	...
	<div class="cta">
		...
		<a href="mailto:{email}" class="btn ghost">Get in touch</a>
		<div class="social">
...
<style>
	.hero {
		position: relative;
		padding: clamp(80px, 14vh, 160px) 0 clamp(64px, 10vh, 120px) 0;
		display: flex;
